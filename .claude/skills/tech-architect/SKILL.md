...
Read the file `/Users/user/Desktop/pocket-it/.claude/agents/tech-architect.md` using the Read tool. Replace every occurrence of `{{ARGUMENTS}}` in the content with this exact value:
