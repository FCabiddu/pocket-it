...
- 2026-09-17 · provisional · WHERE shared/implementing-common.md §3 · WHEN an environment fact is disproved · DO correct it in every file agents read at start, not only where it was found · BECAUSE one left in a binding file came back in an agent report the day it was fixed elsewhere
