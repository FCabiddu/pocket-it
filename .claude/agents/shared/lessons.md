...
- 2026-09-17 · provisional · WHERE shared/implementing-common.md §9 · WHEN a branch is resumed after review · DO rewrite the PR body to the head, not only the report and the comment · BECAUSE a squash merge makes that stale body the permanent commit message on the base
